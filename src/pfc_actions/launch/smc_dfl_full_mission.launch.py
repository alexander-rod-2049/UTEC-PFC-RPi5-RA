...
def generate_launch_description():
    ...
    return LaunchDescription([
        LogInfo(msg="🚀 Iniciando Sistema Autónomo de Limpieza SMC+DFL..."),

        # 1. Hardware Bringup (Motores y Sensores básicos)
        ...
        # 2. Transformada Estática (Base_link a IMU)
        Node(
            package='tf2_ros',
        ...
        # 3. Localización - Filtro de Kalman Extendido
        Node(
        ...
        # 6. Mission Manager (Lanzado con un pequeño delay para asegurar que el server esté listo)
        TimerAction(
            period=5.0,
            actions=[
                Node(
                    package='control_pkg',
                    executable='mission_manager_smc_dfl',
